---
description: Gen Interface
---

# 🧾 Interface Generation Task

I want you to **generate TypeScript interfaces** based on the API response provided below.

---

## 🧱 Requirements

- Define all interfaces inside the `interfaces/` folder.
...
Paste your API response below for interface generation:
