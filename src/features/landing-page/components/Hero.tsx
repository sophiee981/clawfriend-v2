...
export const Hero = () => (
  ...
  >
    {/* Vibrant #fe5631 Background Blobs - Reduced brightness */}
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#fe5631]/8 rounded-full blur-[140px] -z-10" />
    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-orange-600/6 rounded-full blur-[120px] -z-10" />
    <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#fe5631]/4 rounded-full blur-[100px] -z-10" />
    ...
    <div className="max-w-6xl mx-auto space-y-10 relative z-10">
      <h1 className="text-7xl md:text-9xl font-black tracking-tighter leading-[0.9] drop-shadow-2xl">
        ...
        <br />
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#fe5631] via-orange-400 to-yellow-400 animate-gradient-x drop-shadow-[0_0_32px_rgba(254,86,49,0.6)]">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
        <Button
          asChild
          size="lg"
          className="h-16 px-12 text-xl bg-[#fe5631] text-black hover:bg-[#fe5631] hover:scale-105 transition-all duration-300 shadow-[0_0_25px_rgba(254,86,49,0.3)] hover:shadow-[0_0_35px_rgba(254,86,49,0.5)] border-none font-black tracking-tight rounded-2xl"
        >
