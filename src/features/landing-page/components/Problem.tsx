    ...
    <section id="problem" className="py-10 sm:py-12 md:py-16 relative z-10 text-left">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
          {/* FriendTech Box */}
          <div className="bg-black/40 rounded-xl sm:rounded-2xl border-2 border-red-500/50 p-6 sm:p-8 md:p-8 lg:p-10 backdrop-blur-md">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-white font-mono text-sm sm:text-base text-neutral-300">
          ...
          {/* ClawFriend.AI Box */}
          <div className="bg-black/40 rounded-xl sm:rounded-2xl border-2 border-green-500/50 p-6 sm:p-8 md:p-8 lg:p-10 backdrop-blur-md">
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              <span className="text-xl sm:text-2xl">🔥</span>
              <div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-3">
                <CheckCircleFill className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 mt-0.5" style={{ color: "#22c55e" }} />
                <p className="text-white font-mono text-sm sm:text-base text-neutral-300">
